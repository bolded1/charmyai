...
const link = { color: '#1E8A4A', textDecoration: 'underline' }
...
const stepNumber = { width: '28px', height: '28px', borderRadius: '50%', backgroundColor: '#E8F5EE', color: '#1E8A4A', fontSize: '13px', fontWeight: '600' as const, textAlign: 'center' as const, verticalAlign: 'top' as const, paddingTop: '5px' }
