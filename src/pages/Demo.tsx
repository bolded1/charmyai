  ...
  return (
    <div>
      <section className="pt-24 md:pt-28 pb-4 relative overflow-hidden">
        ...
        <div className="absolute top-[10%] right-[-10%] w-[400px] h-[400px] rounded-full opacity-10 blur-3xl pointer-events-none" style={{ background: 'radial-gradient(circle, hsl(265 55% 55% / 0.5), transparent 70%)' }} />
