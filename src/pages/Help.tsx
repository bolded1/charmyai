...
const helpArticles: HelpArticle[] = [
  ...
  },
  {
    id: "contacts",
    title: "Contacts",
    description: "Manage suppliers and customers — auto-built from invoices or added manually.",
    icon: Contact,
    iconColor: "icon-bg-rose",
    category: "Organization",
    content: [
      ...
      "Each contact card shows the total number of associated documents, total amounts per currency, and the date of the most recent transaction.",
      "Search and filter contacts by name, or switch between Suppliers, Customers, and Both tabs to narrow your view.",
      "Click any contact to open a detailed profile that shows all linked expense and income invoices in one place.",
      "Inside a contact profile, you can view per-currency breakdowns, see the list of categories used, and click through to edit individual invoices.",
      "Add contacts manually with the '+ Add Contact' button — enter a name, type (supplier or customer), VAT number, email, and phone number.",
      "Edit or delete manual contacts at any time. Auto-detected contacts update automatically as new documents are processed.",
      "Use the quick-export button on a contact profile to download all associated invoices as a ZIP archive.",
      "Contacts are workspace-scoped — each client workspace in a firm plan has its own separate contact list.",
    ],
  },
  {
    id: "reports",
    title: "Reports & Analytics",
    description: "Visualize income, expenses, and profitability with interactive charts.",
    icon: PieChart,
    iconColor: "icon-bg-teal",
    category: "Finance",
    isNew: true,
    content: [
      "Go to the Reports page from the sidebar to see a comprehensive overview of your financial performance.",
      "Choose a time period using the preset selector: This Month, Last Month, This Quarter, Last Quarter, This Year, or Last Year.",
      "Switch between currencies if you have records in multiple currencies — each currency shows its own set of metrics.",
      "At the top, summary cards display total Income, total Expenses, and Net Profit for the selected period, each with a trend indicator comparing to the previous period.",
      "The Revenue vs Expenses bar chart plots monthly income and expenses side-by-side, with a profit trend line overlaid so you can spot patterns at a glance.",
      "The Expense Breakdown pie chart shows spending split by category, helping you identify your largest cost areas.",
      "Hover over any bar or pie slice to see the exact amount and category name in a tooltip.",
      "Export your report as a professional PDF with one click using the 'Export PDF' button — the generated file includes all charts and summary data.",
      "Reports update in real time as new documents are processed or records are added, so you're always looking at the latest data.",
      "All calculations are based on your approved expense and income records, ensuring accuracy and consistency with your exported data.",
    ],
  },
  {
    id: "support-tickets",
