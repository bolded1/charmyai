...
const pages: PageConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "heroBadge", label: "Hero Badge Text", type: "input" },
      { key: "proTitle", label: "Pro Plan Name", type: "input" },
      { key: "proDesc", label: "Pro Plan Description", type: "input" },
      { key: "trust1", label: "Trust Badge 1", type: "input" },
      { key: "trust2", label: "Trust Badge 2", type: "input" },
      { key: "trust3", label: "Trust Badge 3", type: "input" },
      { key: "ctaTitle", label: "Bottom CTA Title", type: "input" },
      { key: "ctaSubtitle", label: "Bottom CTA Subtitle", type: "input" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "titleGradient", label: "Title (Gradient Part)", type: "input" },
      { key: "intro", label: "Hero Subtitle", type: "textarea" },
      { key: "storyLabel", label: "Story Section Label", type: "input" },
      { key: "storyTitle", label: "Story Title", type: "input" },
      { key: "storyTitleGradient", label: "Story Title (Gradient Part)", type: "input" },
      { key: "paragraph1", label: "Story Paragraph 1", type: "textarea" },
      { key: "paragraph2", label: "Story Paragraph 2", type: "textarea" },
      { key: "paragraph3", label: "Story Paragraph 3", type: "textarea" },
      { key: "valuesLabel", label: "Values Section Label", type: "input" },
      { key: "valuesTitle", label: "Values Title", type: "input" },
      { key: "valuesTitleGradient", label: "Values Title (Gradient Part)", type: "input" },
      ...
      { key: "ctaTitle", label: "CTA Title", type: "input" },
      { key: "ctaTitleGradient", label: "CTA Title (Gradient Part)", type: "input" },
      { key: "ctaSubtitle", label: "CTA Subtitle", type: "input" },
      { key: "ctaButton", label: "CTA Button Text", type: "input" },
      { key: "ctaSecondaryButton", label: "CTA Secondary Button", type: "input" },
    ],
  },
  {
    slug: "contact",
    ...
    fields: [
      ...
      { key: "cardEmailTitle", label: "Email Card Title", type: "input" },
      { key: "email", label: "Email Address", type: "input" },
      { key: "cardPhoneTitle", label: "Phone Card Title", type: "input" },
      { key: "phone", label: "Phone Number", type: "input" },
      { key: "cardOfficeTitle", label: "Office Card Title", type: "input" },
      { key: "office", label: "Office Location", type: "input" },
      { key: "cardHoursTitle", label: "Hours Card Title", type: "input" },
      { key: "hours", label: "Business Hours", type: "input" },
      { key: "formSectionLabel", label: "Form Section Label", type: "input" },
      { key: "formTitle", label: "Form Title", type: "input" },
      { key: "formTitleGradient", label: "Form Title (Gradient Part)", type: "input" },
      { key: "formDescription", label: "Form Description", type: "textarea" },
      { key: "responseTitle", label: "Response Time Title", type: "input" },
      { key: "responseDescription", label: "Response Time Description", type: "textarea" },
      { key: "formDisclaimer", label: "Form Disclaimer", type: "input" },
      { key: "ctaTitle", label: "CTA Title", type: "input" },
      { key: "ctaTitleGradient", label: "CTA Title (Gradient Part)", type: "input" },
      { key: "ctaSubtitle", label: "CTA Subtitle", type: "input" },
      { key: "ctaButton", label: "CTA Button Text", type: "input" },
