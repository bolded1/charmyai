...
const pages: PageConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "section1Title", label: "Section 1 Title", type: "input" },
      { key: "section1Body", label: "Section 1 Body", type: "textarea" },
      { key: "section2Title", label: "Section 2 Title", type: "input" },
      { key: "section2Body", label: "Section 2 Body", type: "textarea" },
      { key: "section3Title", label: "Section 3 Title", type: "input" },
      { key: "section3Body", label: "Section 3 Body", type: "textarea" },
      { key: "section4Title", label: "Section 4 Title", type: "input" },
      { key: "section4Body", label: "Section 4 Body", type: "textarea" },
      { key: "section5Title", label: "Section 5 Title", type: "input" },
      { key: "section5Body", label: "Section 5 Body", type: "textarea" },
      { key: "section6Title", label: "Section 6 Title", type: "input" },
      { key: "section6Body", label: "Section 6 Body", type: "textarea" },
      { key: "section7Title", label: "Section 7 Title", type: "input" },
      { key: "section7Body", label: "Section 7 Body", type: "textarea" },
    ],
  },
  {
    slug: "terms",
    ...
    fields: [
      ...
      { key: "section7Title", label: "Section 7 Title", type: "input" },
      { key: "section7Body", label: "Section 7 Body", type: "textarea" },
      { key: "section8Title", label: "Section 8 Title", type: "input" },
      { key: "section8Body", label: "Section 8 Body", type: "textarea" },
    ],
  },
];
