...
import { Search, Eye, Loader2, RefreshCw, UserCheck, Plus, Pencil, Ban } from "lucide-react";
...
export default function AdminUsersPage() {
  ...
  // Re-sync selected user after refresh
  ...
  useEffect(() => {
    if (selected) {
      ...
      if (updated && (updated.role !== selected.role || updated.status !== selected.status)) {
        setSelected(updated);
      }
    }
  }, [users]);
