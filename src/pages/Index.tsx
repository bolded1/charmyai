  ...
  return (
    <div>
      ...
      <section className="relative pt-24 md:pt-36 pb-20 overflow-hidden">
        ...
        <div className="absolute bottom-[-25%] right-[-10%] w-[500px] h-[500px] rounded-full opacity-25 blur-3xl pointer-events-none" style={{ background: 'radial-gradient(circle, hsl(265 55% 55% / 0.4), transparent 70%)' }} />
        <motion.div
